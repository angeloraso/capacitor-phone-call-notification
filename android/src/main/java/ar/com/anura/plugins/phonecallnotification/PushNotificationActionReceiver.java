...
public class PushNotificationActionReceiver extends BroadcastReceiver {
  private static final String TAG = "PushNotificationActionReceiver";

  @Override
  public void onReceive(Context context, Intent intent) {
    Log.d(TAG, "[Push Notification] Push notification action has been received in broadcast receiver");
